...
#if 0
    class INodeDistributableInterventionParameterSetterInterface : public ISupports
    {
    public:
        virtual void SetDemographicCoverage(float new_coverage) = 0;
        virtual void SetMaxDuration(float new_duration) = 0;
    };
#endif
