...
if os.name == "nt":
    ...
    csv_path = os.path.join( settings.input_path, "OutBase.csv" )
...
def get_state_change( update_id ):
    print( "py: get_state_change: " + str(update_id) )
    return population[ update_id ].GetStateChange()
