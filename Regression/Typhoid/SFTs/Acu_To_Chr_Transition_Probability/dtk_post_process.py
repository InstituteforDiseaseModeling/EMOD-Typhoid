        ...
        if len( lines ) == 0 :
            ...
            for x in range(0,9):
                ...
                if actual_count_male== 0:
                    ...
                    sex = "male"
                    report_file.write(
                        "BAD: The probability of becoming a chronic carrier from Acute stage for individual age group {0}, sex {1} is {2}, expected {3}. The {1} Chronic cases is {4}, expected close to {5}.\n".format(
