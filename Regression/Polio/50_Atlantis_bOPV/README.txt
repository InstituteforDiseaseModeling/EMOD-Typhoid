plotAllChartsChris: customized plotAllCharts.py script that allows you to plot a single chart without comparing, as well as moving the argument parsing to only one place.

Copied from 50 tOPV and tweaked from there
