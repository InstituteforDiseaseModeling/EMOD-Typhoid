...
def main():
    ...
    plt.suptitle("PolioSurveyJSONAnalyzer_survey_025_1_1")
    plt.tight_layout()
    plt.figure(2)
    plt.subplot(321)
    ...
    plt.xticks(bins2, ["%s" % i for i in bins])
    plt.title("Type 3 Humoral Log2 Nab")
    plt.suptitle("PolioSurveyJSONAnalyzer_survey_125_1_1")
    plt.tight_layout()
    plt.figure(3)
    plt.subplot(321)
    ...
    plt.xticks(bins2, ["%s" % i for i in bins])
    plt.title("Type 3 Humoral Log2 Nab")
    plt.suptitle("PolioSurveyJSONAnalyzer_survey_225_1_1")
    plt.tight_layout()
    plt.show()
