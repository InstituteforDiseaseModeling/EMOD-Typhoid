...
def main():
    data = json.load(open('output/PolioSurveyJSONAnalyzer_survey_012_1_1.json'))
    ...
    challenge_dose["PV1"] = 1000000.0
    challenge_dose["PV2"] = 0.0
    challenge_dose["PV3"] = 630000.0

    interference["PV1"] = 0.0
    interference["PV2"] = 0.0
    interference["PV3"] = 0.0
    ...
    plt.suptitle("PolioSurveyJSONAnalyzer_survey_012_1_1.json")
    plt.tight_layout()
    plt.show()
