...
def main():
    data = json.load(open('output/PolioSurveyJSONAnalyzer_survey01_1_3.json'))
    data2 = json.load(open('output/PolioSurveyJSONAnalyzer_survey11_1_3.json'))    
    data3 = json.load(open('output/PolioSurveyJSONAnalyzer_survey024_1_3.json'))
