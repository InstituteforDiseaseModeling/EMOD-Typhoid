...
namespace Kernel {
    ...
    float ClimateKoppen::rainfall_base[][4] = { { .2 }, { .03, .03, .4, .03 }, { .25, .02, .02, .02 }, { .02, .02, .25, .02 },
                                                            { .06 }, { .06 }, { .02 }, { .02 },
                                                            { .25 }, { .25 }, { .25 }, { .25, .06, .02, .06 }, { .25, .06, .02, .06 }, { .25, .06, .02, .06 }, { .02, .06, .25, .06 }, { .02, .06, .25, .06 }, { .02, .06, .25, .06 },
                                                            { .08 }, { .08 }, { .08 }, { .08 }, { .15, .06, .01, .06 }, { .15, .06, .01, .06 }, { .15, .06, .01, .06 }, { .01, .06, .15, .06 }, { .01, .06, .15, .06 }, { .01, .06, .15, .06 }, { .01, .06, .15, .06 },
                                                            { .02 }, { .05 } };
    ...
    float ClimateKoppen::humidity_base[][4] = { { .75 }, { .75 }, { .7, .55, .45, .55 }, { .45, .55, .7, .55 },
                                                            { .45 }, { .45 }, { .3 }, { .3 },
                                                            { .75 }, { .75 }, { .75 }, { .7, .55, .45, .55 }, { .7, .55, .45, .55 }, { .7, .55, .45, .55 }, { .45, .55, .7, .55 }, { .45, .55, .7, .55 }, { .45, .55, .7, .55 },
                                                            { .6 }, { .6 }, { .6 }, { .6 }, { .7, .55, .45, .55 }, { .7, .55, .45, .55 }, { .7, .55, .45, .55 }, { .45, .55, .7, .55 }, { .45, .55, .7, .55 }, { .45, .55, .7, .55 }, { .45, .55, .7, .55 },
                                                            { .6 }, { .6 } };

    float ClimateKoppen::humidity_variance[][4] = { { .15 }, { .15 }, { .1, .05, .05, .05 }, { .05, .05, .1, .05 },
                                                                { .05 }, { .05 }, { .1 }, { .1 },
                                                                { .15 }, { .15 }, { .15 }, { .1, .05, .05, .05 }, { .1, .05, .05, .05 }, { .1, .05, .05, .05 }, { .05, .05, .1, .05 }, { .05, .05, .1, .05 }, { .05, .05, .1, .05 },
                                                                { .1 }, { .1 }, { .1 }, { .1 }, { .1, .05, .05, .05 }, { .1, .05, .05, .05 }, { .1, .05, .05, .05 }, { .05, .05, .1, .05 }, { .05, .05, .1, .05 }, { .05, .05, .1, .05 }, { .05, .05, .1, .05 },
                                                                { .1 }, { .1 } };
