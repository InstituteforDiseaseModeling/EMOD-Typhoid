...
namespace Kernel
{
    ...
    class IDMAPI SimulationConfig : public JsonConfigurable
    {
        ...
        public:
            ...
            MortalityTimeCourse::Enum                            mortality_time_course;                            // MORTALITY_TIME_COURSE
...
#pragma warning( disable: 4251 ) // See IdmApi.h for details
            ...
            float maritalRelLengthMean;
            float maritalRelLengthSpread;
            float maritalRelLengthScale;
            float informalRelLengthMean;
            float informalRelLengthSpread;
            float informalRelLengthScale;
            float transitoryRelLengthMean;
            float transitoryRelLengthSpread;
            float transitoryRelLengthScale;
            ...
            float prob_willing_to_enroll_in_ART;
            float prob_willing_to_enroll_in_PreART;
            float prob_willing_to_enroll_in_ANC;
            float prob_intends_to_breastfeed;
