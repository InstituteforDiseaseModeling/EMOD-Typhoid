...
namespace Kernel
{
    ...
    { LOG_DEBUG( "ctor\n" );
        ...
        initConfigTypeMap("TB_Drug_Primary_Decay_Time_Constant", &TB_drug_primary_decay_time_constant, TB_Drug_Primary_Decay_DESC_TEXT, 0.0, 100000.0, 0.0);
    }
